...
class DatabaseGateway:
    ...
    def create_session(self, session_id: str, game_state: str) -> None:
        ...
        self.table.put_item(Item=row.model_dump(mode="python"),
    ...
    def commit_guess_transaction(self, session_id: str, game_state: str, payout: Decimal) -> None:
        # excutes an atomic  write and delete operation.
        row = GamePermanentDataRow(session_id=session_id, game=game_state, payout=payout)
