from agent_algorithms.heuristic_agent import ReflectionAgent, InvariantAgent, GamblersFallacyAgent
import pytest
...
def test_all_heuristic_agents_guess_range(reflection_agent, invariant_agent, gamblers_fallacy_agent):
