...
class ExpectimaxAgent(Agent):
    ...
    def get_all_possible_sums(self, peeks:list, remaining_faces1:list, remaining_faces2:list, current_depth:int=0, max_depth:int = 10) -> list:
        ...
        valid_pairs = self.get_face_combos(observed_sum, remaining_faces1, remaining_faces2)
